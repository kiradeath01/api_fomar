...
//*
// [{"key":"1","color":"Gris","cantidad":"18"},{"key":"2","color":"Gris","cantidad":"4"},{"key":"1","color":"Gris","cantidad":"1"},{"key":"1","color":"Gris","cantidad":"1"}]
$data = new StdClass();
$data->nombre="jose";
$data->apellidos="alvarez aquino";
$data->correo="chesman021@gmail.com";
$data->cp="86200";
$data->direccion="jalpa de mendez";
$data->estado="tabasco";
$data->monto="$9000";
$data->fecha="7/1/2022";
...
$temp->cantidad=12;
$temp->color="Tinto";
$dataproductos[0]=$temp;
$temp = new StdClass();
$temp->key=4;
$temp->cantidad=10;
$temp->color="Verde";
$dataproductos[1]=$temp;
$temp = new StdClass();
$temp->key=5;
$temp->cantidad=8;
$temp->color="Gris";
$dataproductos[2]=$temp;
$data->productos=$dataproductos;
//echo json_encode($dataproductos);
enviar_correo_fomar($data);
//*/
?>
